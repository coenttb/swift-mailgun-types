...
extension Mailgun.Suppressions.Unsubscribe {
    ...
    public struct Client: Sendable {
        @DependencyEndpoint
        public var get: @Sendable (_ address: EmailAddress) async throws -> Mailgun.Suppressions.Unsubscribe.Record
        ...
        @DependencyEndpoint
        public var deleteAll: @Sendable () async throws -> Mailgun.Suppressions.Unsubscribe.Delete.All.Response
