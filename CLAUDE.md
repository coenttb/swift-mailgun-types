...
This package is part of a deliberate two-package design:
...
coenttb-mailgun (implementation package)
...
## Relationship with coenttb-mailgun

This package provides the types and interfaces that coenttb-mailgun implements:

- **swift-mailgun-types**: Defines WHAT the API should do (contracts)
- **coenttb-mailgun**: Implements HOW to do it (URLSession implementation)
